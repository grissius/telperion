    ...
    Query: {
        ...
        posts: function (parent, args) { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_e) {
                switch (_e.label) {
                    case 0:
                        anchor = tokenToOffset((_a = args.after) !== null && _a !== void 0 ? _a : '-1');
                        limit = (_b = args.first) !== null && _b !== void 0 ? _b : 10;
                        return [4, prismaClient_1.prisma.post.findMany({ where: { id: { gt: anchor } }, take: limit })];
                    case 1:
                        posts = _e.sent();
